...
val gps_path = "/user/jl11257/big_data_project/traces/processed//week*"
...
// save as csv file
df_angle_feature.write.format("csv").option("header", "true").save("/user/jl11257/big_data_project/predictions/vehicleClassification/processedWholeData")